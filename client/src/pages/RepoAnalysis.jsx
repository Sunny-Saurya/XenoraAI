...
import { ArrowLeft, Loader2, FileCode, MessageSquare, BookOpen, Layers, Zap, Info, HelpCircle, Download } from 'lucide-react';
...
const RepoAnalysis = () => {
  ...
  const handleExportDocs = () => {
    ...
    const markdownContent = `# ${analysis.repoName} - Analysis & Documentation

## Overview & Purpose
${explanation.purpose || 'Not available'}

## Architecture & Stack
${explanation.architecture || 'Not available'}

## Workflow
${explanation.workflow || 'Not available'}

## Local Setup
\`\`\`bash
${explanation.setup || 'Not available'}
\`\`\`

## Important Files
${Array.isArray(explanation.importantFiles) ? explanation.importantFiles.map(f => `- ${f}`).join('\\n') : 'Not available'}

---
*Generated by AI Repo Explainer*
`;
    ...
    a.href = url;
    a.download = `${analysis.repoName}-Documentation.md`;
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 relative z-10">
        ...
        <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
          ...
          <button 
            ...
            className="neon-btn px-6 py-3 flex items-center gap-2 shrink-0 self-start md:self-auto hover:scale-105 transition-transform"
          >
            <Download className="w-5 h-5" /> Export Docs
          </button>
        </header>
